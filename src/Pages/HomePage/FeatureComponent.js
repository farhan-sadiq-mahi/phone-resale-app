...
const FeatureComponent = () => {
    return (
        <div className='my-12'>
            <h1 className='text-4xl font-semibold merFont text-center'>Features</h1>
            {/* :FEATURES */}
            <div className="container mt-8 p-5 w-full grid grid-cols-12 sm:grid-cols-5 gap-2 text-xs md:text-sm">
                ...
                <div className="col-span-4 sm:col-span-1 inline-flex flex-col items-center border-r border-gray-300 text-gray-400 uppercase">
                    ...
                    <span className="text-center">Feature Services</span>
                </div>
